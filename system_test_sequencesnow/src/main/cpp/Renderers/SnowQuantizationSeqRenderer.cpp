#include "SnowQuantizationSeqRenderer.h"
#include "lodepng.h"
#include "Common.h"
#include "Texture2D.h"
...
CSnowQuantizationSeqRenderer::CSnowQuantizationSeqRenderer()
{
    __initAlgorithm();
};
...
bool CSnowQuantizationSeqRenderer::__initAlgorithm()
{
    std::string FileName   = "configs/SnowQuantizationConfig.json";
    ...
    m_pBackgroundPlayer = new CSequenceFramePlayer(BackGroundPath, BackSeqRows, BackSeqCols, BackFrameCount, BackPicType);
...
void CSnowQuantizationSeqRenderer::renderScene()
{
    ...
    m_pBackgroundPlayer->updateFrameAndUV(DeltaTime);
    m_pBackgroundPlayer->draw(m_pScreenQuad);
