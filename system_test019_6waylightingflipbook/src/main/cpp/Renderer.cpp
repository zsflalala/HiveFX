...
#include <cassert>
#include <algorithm>
#include "Renderers/CombinedBigSnowFrameRenderer.h"
#include "Renderers/CloudRendererBillBoard.h"
#include "Renderers/CloudRendererSixWayLighting.h"
#include "Common.h"
...
CRenderer::~CRenderer()
{
    ...
    if (m_pCloudRendererSixWayLighting != nullptr)
    {
        delete m_pCloudRendererSixWayLighting;
        m_pCloudRendererSixWayLighting = nullptr;
    }
}
...
*/
    ...
    if (m_pCloudRendererSixWayLighting == nullptr)
        m_pCloudRendererSixWayLighting = new CCloudRendererSixWayLighting(m_pApp);
    m_pCloudRendererSixWayLighting->renderScene(m_WindowWidth, m_WindowHeight);
