...
namespace hiveVG
{
    ...
    public:
        ...
        CSingleTexturePlayer(const std::string& vTexturePath, int vSequenceRows, int vSequenceCols,int  vOneTextureFrames, EPictureType::EPictureType vPictureType ,int vTextureCount);
