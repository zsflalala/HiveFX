...
CTexture2D* CTexture2D::loadTexture(const std::string &vTexturePath, int &voWidth, int &voHeight, EPictureType::EPictureType& vPictureType, bool vIsCompressed,bool vFlipYAxis)
{
    ...
    {
        stbi_set_flip_vertically_on_load(vFlipYAxis);
