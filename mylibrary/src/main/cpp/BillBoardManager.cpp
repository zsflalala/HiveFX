...
void CBillBoardManager::initSequenceState()
{
    for (int i = 0; i < m_SequencePlayers.size(); i++)
    {
...
void CBillBoardManager::updateFrameAndUV(int vWindowWidth, int vWindowHeight, double vDeltaTime)
{
    for (int i = 0; i < m_SequencePlayers.size(); i++)
    {
...
void CBillBoardManager::setLoop(bool vLoop)
{
    for (int i = 0; i < m_SequencePlayers.size(); i++)
    {
...
void CBillBoardManager::setFrameRate(int vFrameRate)
{
    for (int i = 0; i < m_SequencePlayers.size(); i++)
    {
...
void CBillBoardManager::setRotationAngle(float vRotationAngle)
{
    for (int i = 0; i < m_SequencePlayers.size(); i++)
    {
...
void CBillBoardManager::setScreenUvOffset(glm::vec2& vUVOffset)
{
    for (int i = 0; i < m_SequencePlayers.size(); i++)
    {
...
SSequenceState CBillBoardManager::__initSequenceParams()
{
...
void CBillBoardManager::setBlendStatus(bool vStatus)
{
    if(!m_pTexBlender)
    {
        m_IsBlend = false;
