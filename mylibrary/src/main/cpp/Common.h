...
DECLARE_ENUM(EPictureType, PNG = 0, JPG, WEBP, PNG8, ASTC, ETC1, ETC2)
...
namespace hiveVG
{
    ...
    // Shaders config path
    const static std::string SixWayLightTexVert    = "shaders/sequenceSixWayLightTexturePlayer.vert";
    const static std::string SixWayLightTexFrag    = "shaders/sequenceSixWayLightTexturePlayer.frag";
