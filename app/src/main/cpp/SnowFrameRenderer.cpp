...
CSnowFrameRenderer::CSnowFrameRenderer(android_app *vApp) : m_pApp(vApp)
{
    __initAlgorithm();
}

CSnowFrameRenderer::~CSnowFrameRenderer()
{
...
void CSnowFrameRenderer::__initAlgorithm()
{
...
void CSnowFrameRenderer::renderScene(int vWindowWidth, int vWindowHeight)
{
...
double CSnowFrameRenderer::__getCurrentTime()
{
    struct timeval tv;
