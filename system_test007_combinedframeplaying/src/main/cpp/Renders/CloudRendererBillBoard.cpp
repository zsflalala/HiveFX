...
void CCloudRendererBillBoard::__initAlgorithm()
{
    ...
    CSequenceFramePlayer* Cloud2Scene = new CSequenceFramePlayer(CloudFramePath, CloudRows, CloudCols, CloudFrameCount,m_PictureType);
    ...
    CSequenceFramePlayer* Cloud4Scene = new CSequenceFramePlayer(CloudFramePath, CloudRows, CloudCols, CloudFrameCount,m_PictureType);
    ...
    CSequenceFramePlayer* Cloud5Scene = new CSequenceFramePlayer(CloudFramePath, CloudRows, CloudCols, CloudFrameCount,m_PictureType);
