...
#include "Renderers/CombinedBigRainFrameRenderer.h"
#include "Renderers/CombinedSmallSnowFrameRenderer.h"
#include "Renderers/CombinedSmallRainFrameRenderer.h"
#include "Renderers/CombinedSnowCoverFrameRenderer.h"
...
void CRenderer::renderScene()
{
    ...
    if (m_pBigSnowRenderer == nullptr) m_pBigSnowRenderer = new CCombinedBigSnowFrameRenderer(m_pApp);
