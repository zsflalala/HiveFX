#include "CombinedBigRainFrameRenderer.h"
...
CCombinedBigRainFrameRenderer::CCombinedBigRainFrameRenderer(android_app *vApp) : m_pApp(vApp)
{
    __initAlgorithm();
}

CCombinedBigRainFrameRenderer::~CCombinedBigRainFrameRenderer()
{
...
void CCombinedBigRainFrameRenderer::__initAlgorithm()
{
    ...
    Json::Value RainBackConfig=JsonReader.getObject("BigRainBack");
    Json::Value RainForeConfig=JsonReader.getObject("BigRainFore");
...
void CCombinedBigRainFrameRenderer::renderScene(int vWindowWidth, int vWindowHeight)
{
